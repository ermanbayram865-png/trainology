...
const image = "/images/hero/dumbbell.png";

export const movements: readonly Movement[] = [
  {
    id: "barbell-bench-press", name: "Barbell Bench Press", slug: "barbell-bench-press", category: "Push", muscleGroup: "Chest", equipment: "Barbell", difficulty: "Intermediate", image: "/images/movements/barbell-bench-press.png",
  ...
  {
    id: "incline-dumbbell-press", name: "Incline Dumbbell Press", slug: "incline-dumbbell-press", category: "Push", muscleGroup: "Chest", equipment: "Dumbbell", difficulty: "Intermediate", image,
  ...
  {
    id: "overhead-press", name: "Overhead Press", slug: "overhead-press", category: "Push", muscleGroup: "Shoulders", equipment: "Barbell", difficulty: "Intermediate", image,
  ...
  {
    id: "dumbbell-lateral-raise", name: "Dumbbell Lateral Raise", slug: "dumbbell-lateral-raise", category: "Push", muscleGroup: "Shoulders", equipment: "Dumbbell", difficulty: "Beginner", image,
  ...
  {
    id: "triceps-pushdown", name: "Triceps Pushdown", slug: "triceps-pushdown", category: "Push", muscleGroup: "Arms", equipment: "Cable", difficulty: "Beginner", image,
  ...
  {
    id: "pull-up", name: "Pull Up", slug: "pull-up", category: "Pull", muscleGroup: "Back", equipment: "Bodyweight", difficulty: "Intermediate", image,
  ...
  {
    id: "lat-pulldown", name: "Lat Pulldown", slug: "lat-pulldown", category: "Pull", muscleGroup: "Back", equipment: "Machine", difficulty: "Beginner", image,
  ...
  {
    id: "barbell-row", name: "Barbell Row", slug: "barbell-row", category: "Pull", muscleGroup: "Back", equipment: "Barbell", difficulty: "Intermediate", image,
  ...
  {
    id: "seated-cable-row", name: "Seated Cable Row", slug: "seated-cable-row", category: "Pull", muscleGroup: "Back", equipment: "Cable", difficulty: "Beginner", image,
  ...
  {
    id: "dumbbell-curl", name: "Dumbbell Curl", slug: "dumbbell-curl", category: "Pull", muscleGroup: "Arms", equipment: "Dumbbell", difficulty: "Beginner", image,
  ...
  {
    id: "barbell-back-squat", name: "Barbell Back Squat", slug: "barbell-back-squat", category: "Legs", muscleGroup: "Legs", equipment: "Barbell", difficulty: "Intermediate", image,
  ...
  {
    id: "romanian-deadlift", name: "Romanian Deadlift", slug: "romanian-deadlift", category: "Legs", muscleGroup: "Legs", equipment: "Barbell", difficulty: "Intermediate", image,
  ...
  {
    id: "leg-press", name: "Leg Press", slug: "leg-press", category: "Legs", muscleGroup: "Legs", equipment: "Machine", difficulty: "Beginner", image,
  ...
  {
    id: "leg-curl", name: "Leg Curl", slug: "leg-curl", category: "Legs", muscleGroup: "Legs", equipment: "Machine", difficulty: "Beginner", image,
  ...
  {
    id: "leg-extension", name: "Leg Extension", slug: "leg-extension", category: "Legs", muscleGroup: "Legs", equipment: "Machine", difficulty: "Beginner", image,
  ...
  {
    id: "plank", name: "Plank", slug: "plank", category: "Core", muscleGroup: "Core", equipment: "Bodyweight", difficulty: "Beginner", image,
  ...
  {
    id: "hanging-leg-raise", name: "Hanging Leg Raise", slug: "hanging-leg-raise", category: "Core", muscleGroup: "Core", equipment: "Bodyweight", difficulty: "Intermediate", image,
  ...
  {
    id: "deadlift", name: "Deadlift", slug: "deadlift", category: "Full Body / Olympic", muscleGroup: "Full Body", equipment: "Barbell", difficulty: "Intermediate", image,
  ...
  {
    id: "dumbbell-goblet-squat", name: "Dumbbell Goblet Squat", slug: "dumbbell-goblet-squat", category: "Full Body / Olympic", muscleGroup: "Legs", equipment: "Dumbbell", difficulty: "Beginner", image,
  ...
  {
    id: "farmer-walk", name: "Farmer Walk", slug: "farmer-walk", category: "Full Body / Olympic", muscleGroup: "Full Body", equipment: "Dumbbell", difficulty: "Intermediate", image,
